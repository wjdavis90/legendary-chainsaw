...
Downy_mildews_tidy <- read.csv(file="DM_Americas_210209-4.csv", header =TRUE)%>%
clean_names() %>%
...
North_American_downy_mildews_tidy_dedup98 <-dedup(North_American_downy_mildews_tidy, how="one", tolerance=0.98)

write.table(North_American_downy_mildews_tidy_dedup98, "North_American_downy_mildews_tidy_dedup_t98_20210209-12.txt", sep="\t")

North_American_downy_mildews_tidy_dedup99 <-dedup(North_American_downy_mildews_tidy, how="one", tolerance=0.99)

write.table(North_American_downy_mildews_tidy_dedup99, "North_American_downy_mildews_tidy_dedup_t99_20210209-13.txt", sep="\t")
